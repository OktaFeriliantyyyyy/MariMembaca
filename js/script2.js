var books = [];
var RENDER_EVENT = 'render_book';
var SAVED_EVENT = 'saved_book';
var STORAGE_KEY = 'BOOKSHELFAPPS';
inputBookIsComplete.addEventListener('change', function () {
    const bookSubmit = document.querySelector('#bookSubmit>span')
    if (inputBookIsComplete.checked) {
        bookSubmit.innerText = 'Buku Sudah Selesai Dibaca'
    } else {
        bookSubmit.innerText = 'Saat ini Buku Belum Selesai Dibaca'
    }
})
